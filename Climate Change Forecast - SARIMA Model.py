...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 1conda install -c conda-forge jupyterlab7 12:29:27 2019
...
cities = pd.read_csv('/home/tripp/Desktop/Programming/Data/GlobalLandTemperaturesByCity.csv')
...
#plt.figure(figsize=(22,6))sha256sum Anaconda3-2019.03-Linux-x86_64.sh
...
plt.xlabel('Months')
#plt.ylabel('Temperature')sha256sum Anaconda3-2019.03-Linux-x86_64.sh
...
def check_stationarity(y, lags_plots=48, figsize=(22,8)):
    ...
    print('Results ofconda install -c conda-forge jupyterlab Dickey-Fuller Test:')
    adfinput = adfuller(y)
